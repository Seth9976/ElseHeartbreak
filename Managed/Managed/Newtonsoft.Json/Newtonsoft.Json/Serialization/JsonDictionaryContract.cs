...
namespace Newtonsoft.Json.Serialization
{
	...
	public class JsonDictionaryContract : JsonContract
	{
		...
		// (get) Token: 0x0600061C RID: 1564 RVA: 0x0001556F File Offset: 0x0001376F
		// (set) Token: 0x0600061D RID: 1565 RVA: 0x00015577 File Offset: 0x00013777
		public Func<string, string> PropertyNameResolver { get; set; }

		// Token: 0x17000130 RID: 304
		// (get) Token: 0x0600061E RID: 1566 RVA: 0x00015580 File Offset: 0x00013780
		// (set) Token: 0x0600061F RID: 1567 RVA: 0x00015588 File Offset: 0x00013788
		internal Type DictionaryKeyType { get; private set; }

		// Token: 0x17000131 RID: 305
		// (get) Token: 0x06000620 RID: 1568 RVA: 0x00015591 File Offset: 0x00013791
		// (set) Token: 0x06000621 RID: 1569 RVA: 0x00015599 File Offset: 0x00013799
		internal Type DictionaryValueType { get; private set; }

		// Token: 0x06000622 RID: 1570 RVA: 0x000155A4 File Offset: 0x000137A4
		...
		// Token: 0x06000623 RID: 1571 RVA: 0x0001567C File Offset: 0x0001387C
		...
		// Token: 0x06000624 RID: 1572 RVA: 0x00015730 File Offset: 0x00013930
