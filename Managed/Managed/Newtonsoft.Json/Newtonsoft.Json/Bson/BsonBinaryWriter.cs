...
namespace Newtonsoft.Json.Bson
{
	...
	internal class BsonBinaryWriter
	{
		...
		private void WriteTokenInternal(BsonToken t)
		{
			...
			throw new ArgumentOutOfRangeException("t", "Unexpected token when writing BSON: {0}".FormatWith(CultureInfo.InvariantCulture, new object[] { t.Type }));
		}
		...
		// Token: 0x0600000A RID: 10 RVA: 0x000025E1 File Offset: 0x000007E1
		private int CalculateSize(int stringByteCount)
		{
			return stringByteCount + 1;
		}

		// Token: 0x0600000B RID: 11 RVA: 0x000025E8 File Offset: 0x000007E8
		...
		// Token: 0x0600000C RID: 12 RVA: 0x00002600 File Offset: 0x00000800
