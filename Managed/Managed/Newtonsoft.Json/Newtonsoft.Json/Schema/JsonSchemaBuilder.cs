...
namespace Newtonsoft.Json.Schema
{
	...
	{
		// Token: 0x0600069D RID: 1693 RVA: 0x00015D23 File Offset: 0x00013F23
		...
		// Token: 0x0600069E RID: 1694 RVA: 0x00015D4C File Offset: 0x00013F4C
		...
		// (get) Token: 0x0600069F RID: 1695 RVA: 0x00015D8A File Offset: 0x00013F8A
		...
		// Token: 0x060006A0 RID: 1696 RVA: 0x00015D92 File Offset: 0x00013F92
		...
		// Token: 0x060006A1 RID: 1697 RVA: 0x00015DAC File Offset: 0x00013FAC
		...
		// Token: 0x060006A2 RID: 1698 RVA: 0x00015DD0 File Offset: 0x00013FD0
		private JsonSchema BuildSchema()
		{
			...
			while (this._reader.Read() && this._reader.TokenType != JsonToken.EndObject)
			{
				if (this._reader.TokenType == JsonToken.StartObject)
				{
					throw new Exception("Found StartObject within the schema reference with the Id '{0}'".FormatWith(CultureInfo.InvariantCulture, new object[] { text2 }));
				}
			}
			JsonSchema schema = this._resolver.GetSchema(text2);
			if (schema == null)
			{
				throw new Exception("Could not resolve schema reference for Id '{0}'.".FormatWith(CultureInfo.InvariantCulture, new object[] { text2 }));
			}
			return schema;
		}

		// Token: 0x060006A3 RID: 1699 RVA: 0x00015F70 File Offset: 0x00014170
		...
		// Token: 0x060006A4 RID: 1700 RVA: 0x00016467 File Offset: 0x00014667
		private void ProcessExtends()
		{
			this.CurrentSchema.Extends = this.BuildSchema();
		}

		// Token: 0x060006A5 RID: 1701 RVA: 0x0001647C File Offset: 0x0001467C
		...
		// Token: 0x060006A6 RID: 1702 RVA: 0x00016514 File Offset: 0x00014714
		private void ProcessOptions()
		{
			...
			while (this._reader.Read())
			{
				...
				while (this._reader.Read() && this._reader.TokenType != JsonToken.EndObject)
				{
					...
					throw new Exception("Unexpected property in JSON schema option: {0}.".FormatWith(CultureInfo.InvariantCulture, new object[] { text2 }));
				}
				if (jtoken == null)
				{
				...
				{
					throw new Exception("Duplicate value in JSON schema option collection: {0}".FormatWith(CultureInfo.InvariantCulture, new object[] { jtoken }));
				}
				this.CurrentSchema.Options.Add(jtoken, text);
			}
		}

		// Token: 0x060006A7 RID: 1703 RVA: 0x000166EC File Offset: 0x000148EC
		private void ProcessDefault()
		{
			this.CurrentSchema.Default = JToken.ReadFrom(this._reader);
		}

		// Token: 0x060006A8 RID: 1704 RVA: 0x00016704 File Offset: 0x00014904
		...
		// Token: 0x060006A9 RID: 1705 RVA: 0x00016809 File Offset: 0x00014A09
		...
		// Token: 0x060006AA RID: 1706 RVA: 0x00016848 File Offset: 0x00014A48
		private void ProcessPatternProperties()
		{
			...
			while (this._reader.Read() && this._reader.TokenType != JsonToken.EndObject)
			{
				...
				{
					throw new Exception("Property {0} has already been defined in schema.".FormatWith(CultureInfo.InvariantCulture, new object[] { text }));
				}
		...
		// Token: 0x060006AB RID: 1707 RVA: 0x000168F8 File Offset: 0x00014AF8
		...
		// Token: 0x060006AC RID: 1708 RVA: 0x000169B0 File Offset: 0x00014BB0
		...
		// Token: 0x060006AD RID: 1709 RVA: 0x00016A88 File Offset: 0x00014C88
		...
		// Token: 0x060006AE RID: 1710 RVA: 0x00016BA4 File Offset: 0x00014DA4
		...
		// Token: 0x060006AF RID: 1711 RVA: 0x00016BFC File Offset: 0x00014DFC
