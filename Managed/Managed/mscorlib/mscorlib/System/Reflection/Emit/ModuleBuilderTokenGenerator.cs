...
namespace System.Reflection.Emit
{
	...
	{
		// Token: 0x06002690 RID: 9872 RVA: 0x000885AC File Offset: 0x000867AC
		public ModuleBuilderTokenGenerator(ModuleBuilder mb)
		{
			this.mb = mb;
		}

		// Token: 0x06002691 RID: 9873 RVA: 0x000885BC File Offset: 0x000867BC
		public int GetToken(string str)
		{
			return this.mb.GetToken(str);
		}

		// Token: 0x06002692 RID: 9874 RVA: 0x000885CC File Offset: 0x000867CC
		public int GetToken(MemberInfo member)
		{
			return this.mb.GetToken(member);
		}

		// Token: 0x06002693 RID: 9875 RVA: 0x000885DC File Offset: 0x000867DC
		public int GetToken(MethodInfo method, Type[] opt_param_types)
		{
			return this.mb.GetToken(method, opt_param_types);
		}

		// Token: 0x06002694 RID: 9876 RVA: 0x000885EC File Offset: 0x000867EC
