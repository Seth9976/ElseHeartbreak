...
namespace System.Reflection
{
	...
	public class TypeDelegator : Type
	{
		...
		// Token: 0x06002351 RID: 9041 RVA: 0x0007E68C File Offset: 0x0007C88C
		...
		// Token: 0x06002352 RID: 9042 RVA: 0x0007E694 File Offset: 0x0007C894
		...
		// (get) Token: 0x06002353 RID: 9043 RVA: 0x0007E6B4 File Offset: 0x0007C8B4
		...
		// (get) Token: 0x06002354 RID: 9044 RVA: 0x0007E6C4 File Offset: 0x0007C8C4
		...
		// (get) Token: 0x06002355 RID: 9045 RVA: 0x0007E6D4 File Offset: 0x0007C8D4
		...
		// (get) Token: 0x06002356 RID: 9046 RVA: 0x0007E6E4 File Offset: 0x0007C8E4
		...
		// (get) Token: 0x06002357 RID: 9047 RVA: 0x0007E6F4 File Offset: 0x0007C8F4
		...
		// (get) Token: 0x06002358 RID: 9048 RVA: 0x0007E704 File Offset: 0x0007C904
		...
		// (get) Token: 0x06002359 RID: 9049 RVA: 0x0007E714 File Offset: 0x0007C914
		...
		// (get) Token: 0x0600235A RID: 9050 RVA: 0x0007E724 File Offset: 0x0007C924
		...
		// (get) Token: 0x0600235B RID: 9051 RVA: 0x0007E734 File Offset: 0x0007C934
		...
		// (get) Token: 0x0600235C RID: 9052 RVA: 0x0007E744 File Offset: 0x0007C944
		...
		// Token: 0x0600235D RID: 9053 RVA: 0x0007E754 File Offset: 0x0007C954
		...
		// Token: 0x0600235E RID: 9054 RVA: 0x0007E764 File Offset: 0x0007C964
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x0600235F RID: 9055 RVA: 0x0007E778 File Offset: 0x0007C978
		[ComVisible(true)]
		...
		// Token: 0x06002360 RID: 9056 RVA: 0x0007E788 File Offset: 0x0007C988
		...
		/// <exception cref="T:System.TypeLoadException">A custom attribute type cannot be loaded. </exception>
		// Token: 0x06002361 RID: 9057 RVA: 0x0007E798 File Offset: 0x0007C998
		...
		// Token: 0x06002362 RID: 9058 RVA: 0x0007E7A8 File Offset: 0x0007C9A8
		...
		// Token: 0x06002363 RID: 9059 RVA: 0x0007E7B8 File Offset: 0x0007C9B8
		...
		// Token: 0x06002364 RID: 9060 RVA: 0x0007E7C8 File Offset: 0x0007C9C8
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x06002365 RID: 9061 RVA: 0x0007E7D4 File Offset: 0x0007C9D4
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="name" /> parameter is null. </exception>
		// Token: 0x06002366 RID: 9062 RVA: 0x0007E7E4 File Offset: 0x0007C9E4
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x06002367 RID: 9063 RVA: 0x0007E7F4 File Offset: 0x0007C9F4
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="name" /> parameter is null. </exception>
		// Token: 0x06002368 RID: 9064 RVA: 0x0007E804 File Offset: 0x0007CA04
		...
		// Token: 0x06002369 RID: 9065 RVA: 0x0007E814 File Offset: 0x0007CA14
		[ComVisible(true)]
		...
		// Token: 0x0600236A RID: 9066 RVA: 0x0007E824 File Offset: 0x0007CA24
		...
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="name" /> parameter is null. </exception>
		// Token: 0x0600236B RID: 9067 RVA: 0x0007E834 File Offset: 0x0007CA34
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x0600236C RID: 9068 RVA: 0x0007E844 File Offset: 0x0007CA44
		...
		/// <param name="types">An array of type Type containing a list of the parameter number, order, and types. Types cannot be null; use an appropriate GetMethod method or an empty array to search for a method without parameters. </param>
		/// <param name="modifiers">An array of type ParameterModifier having the same length as the <paramref name="types" /> array, whose elements represent the attributes associated with the parameters of the method to get. </param>
		// Token: 0x0600236D RID: 9069 RVA: 0x0007E854 File Offset: 0x0007CA54
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x0600236E RID: 9070 RVA: 0x0007E86C File Offset: 0x0007CA6C
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		/// <exception cref="T:System.ArgumentNullException">The <paramref name="name" /> parameter is null. </exception>
		// Token: 0x0600236F RID: 9071 RVA: 0x0007E87C File Offset: 0x0007CA7C
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x06002370 RID: 9072 RVA: 0x0007E88C File Offset: 0x0007CA8C
		...
		/// <param name="bindingAttr">A bitmask that affects the way in which the search is conducted. The value is a combination of zero or more bit flags from <see cref="T:System.Reflection.BindingFlags" />. </param>
		// Token: 0x06002371 RID: 9073 RVA: 0x0007E89C File Offset: 0x0007CA9C
		...
		// Token: 0x06002372 RID: 9074 RVA: 0x0007E8AC File Offset: 0x0007CAAC
		...
		// Token: 0x06002373 RID: 9075 RVA: 0x0007E8C4 File Offset: 0x0007CAC4
		...
		// Token: 0x06002374 RID: 9076 RVA: 0x0007E8D4 File Offset: 0x0007CAD4
		...
		// Token: 0x06002375 RID: 9077 RVA: 0x0007E8FC File Offset: 0x0007CAFC
		...
		// Token: 0x06002376 RID: 9078 RVA: 0x0007E90C File Offset: 0x0007CB0C
		...
		// Token: 0x06002377 RID: 9079 RVA: 0x0007E91C File Offset: 0x0007CB1C
		...
		// Token: 0x06002378 RID: 9080 RVA: 0x0007E92C File Offset: 0x0007CB2C
		...
		// Token: 0x06002379 RID: 9081 RVA: 0x0007E93C File Offset: 0x0007CB3C
		...
		// Token: 0x0600237A RID: 9082 RVA: 0x0007E94C File Offset: 0x0007CB4C
		...
		// Token: 0x0600237B RID: 9083 RVA: 0x0007E95C File Offset: 0x0007CB5C
		...
		// (get) Token: 0x0600237C RID: 9084 RVA: 0x0007E96C File Offset: 0x0007CB6C
