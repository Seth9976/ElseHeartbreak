...
namespace System.Text
{
	...
	public abstract class Decoder
	{
		...
		// (get) Token: 0x06003EA0 RID: 16032 RVA: 0x000D7318 File Offset: 0x000D5518
		// (set) Token: 0x06003EA1 RID: 16033 RVA: 0x000D7320 File Offset: 0x000D5520
		[ComVisible(false)]
		...
		// (get) Token: 0x06003EA2 RID: 16034 RVA: 0x000D733C File Offset: 0x000D553C
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA5 RID: 16037 RVA: 0x000D736C File Offset: 0x000D556C
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA6 RID: 16038 RVA: 0x000D7384 File Offset: 0x000D5584
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA7 RID: 16039 RVA: 0x000D73D4 File Offset: 0x000D55D4
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA8 RID: 16040 RVA: 0x000D7410 File Offset: 0x000D5610
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA9 RID: 16041 RVA: 0x000D7464 File Offset: 0x000D5664
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EAA RID: 16042 RVA: 0x000D747C File Offset: 0x000D567C
		[CLSCompliant(false)]
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EAB RID: 16043 RVA: 0x000D74E4 File Offset: 0x000D56E4
		[ComVisible(false)]
		...
		// Token: 0x06003EAC RID: 16044 RVA: 0x000D7578 File Offset: 0x000D5778
		...
		// Token: 0x06003EAD RID: 16045 RVA: 0x000D75B4 File Offset: 0x000D57B4
		...
		// Token: 0x06003EAE RID: 16046 RVA: 0x000D760C File Offset: 0x000D580C
