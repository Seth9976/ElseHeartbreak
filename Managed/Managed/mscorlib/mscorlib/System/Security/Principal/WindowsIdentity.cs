...
namespace System.Security.Principal
{
	...
	public class WindowsIdentity : IDisposable, ISerializable, IDeserializationCallback, IIdentity
	{
		...
		// Token: 0x06003E50 RID: 15952 RVA: 0x000D6114 File Offset: 0x000D4314
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003E51 RID: 15953 RVA: 0x000D6120 File Offset: 0x000D4320
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003E52 RID: 15954 RVA: 0x000D612C File Offset: 0x000D432C
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		///   <paramref name="userToken" /> is 0.-or-<paramref name="userToken" /> is duplicated and invalid for impersonation.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003E53 RID: 15955 RVA: 0x000D6138 File Offset: 0x000D4338
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		// Token: 0x06003E54 RID: 15956 RVA: 0x000D6170 File Offset: 0x000D4370
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		/// <exception cref="T:System.OutOfMemoryException">There is insufficient memory available.</exception>
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. </exception>
		// Token: 0x06003E55 RID: 15957 RVA: 0x000D617C File Offset: 0x000D437C
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		/// <exception cref="T:System.Security.SecurityException">The caller does not have the correct permissions. -or-A Win32 error occurred.</exception>
		// Token: 0x06003E56 RID: 15958 RVA: 0x000D61E8 File Offset: 0x000D43E8
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		// Token: 0x06003E58 RID: 15960 RVA: 0x000D6204 File Offset: 0x000D4404
		...
		// Token: 0x06003E59 RID: 15961 RVA: 0x000D6314 File Offset: 0x000D4514
		...
		// Token: 0x06003E5A RID: 15962 RVA: 0x000D6380 File Offset: 0x000D4580
		[ComVisible(false)]
		public void Dispose()
		{
		...
		// Token: 0x06003E5B RID: 15963 RVA: 0x000D6390 File Offset: 0x000D4590
		[ComVisible(false)]
		...
		// Token: 0x06003E5C RID: 15964 RVA: 0x000D63A0 File Offset: 0x000D45A0
		...
		/// </PermissionSet>
		// Token: 0x06003E5D RID: 15965 RVA: 0x000D6400 File Offset: 0x000D4600
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003E5E RID: 15966 RVA: 0x000D6410 File Offset: 0x000D4610
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003E5F RID: 15967 RVA: 0x000D6418 File Offset: 0x000D4618
		[MonoTODO("need icall changes")]
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003E60 RID: 15968 RVA: 0x000D6420 File Offset: 0x000D4620
		...
		///   <IPermission class="System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.3600.0, Culture=neutral, PublicKeyToken=b77a5c561934e089" version="1" Flags="ControlPrincipal" />
		/// </PermissionSet>
		// Token: 0x06003E61 RID: 15969 RVA: 0x000D6430 File Offset: 0x000D4630
		[PermissionSet(SecurityAction.Demand, XML = "<PermissionSet class=\"System.Security.PermissionSet\"\n               version=\"1\">\n   <IPermission class=\"System.Security.Permissions.SecurityPermission, mscorlib, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089\"\n                version=\"1\"\n                Flags=\"ControlPrincipal\"/>\n</PermissionSet>\n")]
		...
		// (get) Token: 0x06003E62 RID: 15970 RVA: 0x000D6438 File Offset: 0x000D4638
		...
		// (get) Token: 0x06003E63 RID: 15971 RVA: 0x000D6440 File Offset: 0x000D4640
		...
		// (get) Token: 0x06003E64 RID: 15972 RVA: 0x000D644C File Offset: 0x000D464C
		...
		// (get) Token: 0x06003E65 RID: 15973 RVA: 0x000D6454 File Offset: 0x000D4654
		...
		// (get) Token: 0x06003E66 RID: 15974 RVA: 0x000D6460 File Offset: 0x000D4660
		...
		// (get) Token: 0x06003E67 RID: 15975 RVA: 0x000D646C File Offset: 0x000D466C
		...
		// (get) Token: 0x06003E68 RID: 15976 RVA: 0x000D649C File Offset: 0x000D469C
		...
		// (get) Token: 0x06003E69 RID: 15977 RVA: 0x000D64A4 File Offset: 0x000D46A4
		...
		// (get) Token: 0x06003E6A RID: 15978 RVA: 0x000D64AC File Offset: 0x000D46AC
		[MonoTODO("not implemented")]
		[ComVisible(false)]
		...
		// (get) Token: 0x06003E6B RID: 15979 RVA: 0x000D64B4 File Offset: 0x000D46B4
		[MonoTODO("not implemented")]
		[ComVisible(false)]
		...
		// (get) Token: 0x06003E6C RID: 15980 RVA: 0x000D64BC File Offset: 0x000D46BC
		[ComVisible(false)]
		[MonoTODO("not implemented")]
		...
		// (get) Token: 0x06003E6D RID: 15981 RVA: 0x000D64C4 File Offset: 0x000D46C4
		...
		// Token: 0x06003E6E RID: 15982 RVA: 0x000D64F0 File Offset: 0x000D46F0
