...
namespace System.Security.Cryptography
{
	...
	public class SHA512Managed : SHA512
	{
		...
		// Token: 0x06003974 RID: 14708 RVA: 0x000C512C File Offset: 0x000C332C
		...
		// Token: 0x06003975 RID: 14709 RVA: 0x000C5160 File Offset: 0x000C3360
		...
		// Token: 0x06003976 RID: 14710 RVA: 0x000C5250 File Offset: 0x000C3450
		...
		// Token: 0x06003977 RID: 14711 RVA: 0x000C525C File Offset: 0x000C345C
		...
		// Token: 0x06003978 RID: 14712 RVA: 0x000C52FC File Offset: 0x000C34FC
		...
		// Token: 0x06003979 RID: 14713 RVA: 0x000C53D4 File Offset: 0x000C35D4
		...
		// Token: 0x0600397A RID: 14714 RVA: 0x000C5430 File Offset: 0x000C3630
		...
		// Token: 0x0600397B RID: 14715 RVA: 0x000C54B4 File Offset: 0x000C36B4
		...
		// Token: 0x0600397C RID: 14716 RVA: 0x000C550C File Offset: 0x000C370C
		...
		// Token: 0x0600397D RID: 14717 RVA: 0x000C555C File Offset: 0x000C375C
		...
		// Token: 0x0600397E RID: 14718 RVA: 0x000C5588 File Offset: 0x000C3788
		...
		// Token: 0x0600397F RID: 14719 RVA: 0x000C5748 File Offset: 0x000C3948
		private ulong rotateRight(ulong x, int n)
		{
			return (x >> n) | (x << 64 - n);
		}

		// Token: 0x06003980 RID: 14720 RVA: 0x000C575C File Offset: 0x000C395C
		private ulong Ch(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (~x & z);
		}

		// Token: 0x06003981 RID: 14721 RVA: 0x000C5768 File Offset: 0x000C3968
		private ulong Maj(ulong x, ulong y, ulong z)
		{
			return (x & y) ^ (x & z) ^ (y & z);
		}

		// Token: 0x06003982 RID: 14722 RVA: 0x000C5778 File Offset: 0x000C3978
		private ulong Sum0(ulong x)
		{
			return this.rotateRight(x, 28) ^ this.rotateRight(x, 34) ^ this.rotateRight(x, 39);
		}

		// Token: 0x06003983 RID: 14723 RVA: 0x000C57A4 File Offset: 0x000C39A4
		private ulong Sum1(ulong x)
		{
			return this.rotateRight(x, 14) ^ this.rotateRight(x, 18) ^ this.rotateRight(x, 41);
		}

		// Token: 0x06003984 RID: 14724 RVA: 0x000C57D0 File Offset: 0x000C39D0
		private ulong Sigma0(ulong x)
		{
			return this.rotateRight(x, 1) ^ this.rotateRight(x, 8) ^ (x >> 7);
		}

		// Token: 0x06003985 RID: 14725 RVA: 0x000C57E8 File Offset: 0x000C39E8
