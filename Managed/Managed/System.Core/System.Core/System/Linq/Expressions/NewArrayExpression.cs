...
namespace System.Linq.Expressions
{
	...
	{
		// Token: 0x0600047C RID: 1148 RVA: 0x00013E10 File Offset: 0x00012010
		...
		// (get) Token: 0x0600047D RID: 1149 RVA: 0x00013E24 File Offset: 0x00012024
		...
		// Token: 0x0600047E RID: 1150 RVA: 0x00013E2C File Offset: 0x0001202C
		...
		// Token: 0x0600047F RID: 1151 RVA: 0x00013EC0 File Offset: 0x000120C0
		...
		// Token: 0x06000480 RID: 1152 RVA: 0x00013F18 File Offset: 0x00012118
		...
		// Token: 0x06000481 RID: 1153 RVA: 0x00013F2C File Offset: 0x0001212C
		private static Type[] CreateTypeParameters(int rank)
		{
			return Enumerable.Repeat<Type>(typeof(int), rank).ToArray<Type>();
		}

		// Token: 0x06000482 RID: 1154 RVA: 0x00013F44 File Offset: 0x00012144
		private static Type CreateArray(Type type, int rank)
		{
			return type.MakeArrayType(rank);
		}

		// Token: 0x06000483 RID: 1155 RVA: 0x00013F50 File Offset: 0x00012150
